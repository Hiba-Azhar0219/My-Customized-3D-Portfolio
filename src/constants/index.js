...
export const clientReviews = [
  {
    ...
    review:
      'Working with Hiba was a fantastic experience. She transformed our outdated website into a modern, user-friendly platform. Her attention to detail and commitment to quality are unmatched. Highly recommend him for any web dev projects.',
  },
  {
    id: 2,
    name: 'Mark Rogers',
    ...
    review:
      'Hiba’s expertise in web development is truly impressive. She delivered a robust and scalable solution for our e-commerce site, and our online sales have significantly increased since the launch. She’s a true professional! Fantastic work.',
  },
  {
    id: 3,
    name: 'John Dohsas',
    ...
    review:
      'I can’t say enough good things about Hiba. She was able to take our complex project requirements and turn them into a seamless, functional website. Her problem-solving abilities are outstanding.',
  },
  {
    id: 4,
    name: 'Ether Smith',
    ...
    review:
      'Hiba was a pleasure to work with. She understood our requirements perfectly and delivered a website that exceeded our expectations. Her skills in both frontend backend dev are top-notch.',
  },
]
...
export const workExperiences = [
  {
    ...
    title:
      'Served as a Full-Stack Developer using advanced tech-stack i.e. Next.js, Tailwind CSS, Springboot, Postman and PostgresSQL.',
    icon: '/assets/i2p.png',
  },
  {
    id: 2,
    ...
    title: 'Built basic projects using HTML, CSS and JS.',
  ...
  },
  {
    ...
    title: 'Contributed in Sciene, Maths and English',
    icon: '/assets/als.png',
  },
]
